...
class HomeControllerSpec extends ControllerHelper {
  ...
  "HomeController GET" should {
    ...
    "render the index page from a new instance of controller: v2" in {
      val ec = inject[ExecutionContext]

      val userConnectorMock: UserConnector = setUpMock()
      val userService = UserService(userConnectorMock)(ec)
